...
class WorkspaceFileTree {
  ...
  String get pathAutoGeneratedDart => '$directory/lib/auto_generated.dart';

  static Future<String> _getDir() async =>
      '${Directory.systemTemp.path}/dart_interactive_workspace_${DateTime.now().toIso8601String()}';

  static Future<void> _prepare(String dir) async {
    Directory(dir).createSync(recursive: true);
    Directory('$dir/lib').createSync(recursive: true);
    File('$dir/pubspec.yaml').writeAsStringSync(_kDefaultPubspecYaml);
  }
}
